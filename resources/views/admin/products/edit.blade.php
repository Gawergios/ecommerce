                            ...
                            <form id="form" action="">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div id="categories_id" class="text-danger">

                                        </div>
                                        <label for="exampleInputEmail1">{{__('messages.categories')}}<label>
                                            <select name="categories_id" class="form-control">
                                                <option value="{{$product->categories_id}}">{{__('messages.choose category')}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description" class="form-control"
                                            value="{{$product->description}}" id="exampleInputEmail1" placeholder="{{__('messages.description')}}">
                                        <div id="description" class="text-danger"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">{{__('messages.purchase price')}}</label>
                                        <input type="text" name="purchase_price" class="form-control"
                                            value="{{$product->purchase_price}}"    id="exampleInputEmail1" placeholder="name">
                                        <div id="purchase_price" class="text-danger"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">{{__('messages.sale price')}}</label>
                                        <input type="text" name="sale_price" class="form-control"
                                        value="{{$product->sale_price}}"    id="exampleInputEmail1" placeholder="name">
                                        <div id="sale_price" class="text-danger"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">{{__('messages.stock')}}</label>
                                        <input type="text" name="stock" class="form-control" id="exampleInputEmail1"
                                        value="{{$product->stock}}"    placeholder="name">
                                        <div id="stock" class="text-danger"></div>
                                    </div>


                                    <div class="card-footer">
                                        <button id="update" class="btn btn-primary">{{__('messages.update')}}</button>
                                    </div>

                                    <div id='success' class="alert alert-success" style="display: none;">data updated
                                        successfully</div>
